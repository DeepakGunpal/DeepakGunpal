              ...
              {newFile.map((file, index) =>
                <div className='col-6' key={index}>
                  <div className='card mb-3 border-0 p-0'>
                    <img src={`http://localhost:4000${file.file}`} height='100' className='card-img-top img-responsive mt-2' alt='img' /><br></br>

                  </div>
                  {/* <a href={`http://localhost:4000${file.file}`} className="btn btn-warning mt-4 mb-4" download={`${file.originalname}`} onClick={DownloadFile} target='blank'>Download</a> */}
